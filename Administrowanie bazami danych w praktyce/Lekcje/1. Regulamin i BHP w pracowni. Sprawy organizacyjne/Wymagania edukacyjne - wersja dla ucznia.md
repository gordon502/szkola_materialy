# Wymagania edukacyjne — wersja dla ucznia

**Administrowanie bazami danych w praktyce** | technik informatyk | klasa IV | INF.03 | rok 2026/2027

Pracujemy w XAMPP (MySQL/MariaDB) i phpMyAdmin — tym samym środowisku, w którym zdajesz egzamin zawodowy.
...
- Sprawdziany zapowiadane z tygodniowym wyprzedzeniem, maks. 2 w tygodniu i 1 w danym dniu. Kartkówki z trzech ostatnich tematów mogą odbyć się bez zapowiedzenia.
- Sprawdziany sprawdzane i omawiane w ciągu 14 dni roboczych, kartkówki — 7 dni roboczych.
- Nie napisałeś pracy z powodu nieobecności? Ustalasz z nauczycielem termin — co do zasady w ciągu 7 dni od powrotu do szkoły.
- Poprawy: sprawdziany w 14 dni, kartkówki w 7 dni od wpisania oceny; jednorazowo; przy ustalaniu ocen klasyfikacyjnych liczy się ocena wyższa.
- Nieprzygotowanie: 2 razy w półroczu, zgłoszone przed lekcją; nie zwalnia z zapowiedzianych prac pisemnych i oddania projektu.
- Praca niesamodzielna (ściąganie, oddanie cudzego rozwiązania, rozwiązanie wygenerowane przez AI, którego nie potrafisz objaśnić) — ocena niedostateczna.
- Ocenę klasyfikacyjną ustala nauczyciel na podstawie ocen bieżących z całego okresu; średnia wyświetlana w dzienniku ma charakter informacyjny.
- Laureat lub finalista olimpiady przedmiotowej albo laureat konkursu przedmiotowego o zasięgu wojewódzkim/ponadwojewódzkim — ocena celująca.
- Chcesz wyższą roczną ocenę niż przewidywana? Rodzic (lub Ty, jeśli jesteś pełnoletni) składa pisemną, uzasadnioną prośbę do dyrektora — zdajesz wtedy dodatkowy sprawdzian z wymagań na ocenę, o którą się ubiegasz.

---

Pełna wersja wymagań: u wicedyrektora szkoły oraz w dzienniku elektronicznym (Pliki szkoły). W sprawach nieopisanych w tym dokumencie obowiązuje statut szkoły.
